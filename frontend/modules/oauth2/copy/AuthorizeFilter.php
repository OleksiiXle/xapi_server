...
use frontend\modules\oauth2\responsetypes\Authorization;
use Yii;
...
class AuthorizeFilter extends ActionFilter
{
    ...
    public $responseTypes = [
        'token' => 'frontend\modules\oauth2\responsetypes\Implicit',
        'code' => 'frontend\modules\oauth2\responsetypes\Authorization',
    ];
    ...
    public function finishAuthorization()
    {
        ...
        \yii::trace(\yii\helpers\VarDumper::dumpAsString($redirectUri), "dbg");
